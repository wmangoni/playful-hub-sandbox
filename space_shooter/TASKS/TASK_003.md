...
4. **Fases de Spawn de Chefes e Nomenclatura**: Na decisão do Tech Lead é mencionado: "O Bossnick atuará como o chefe de introdução da Fase 1. A partir da Fase 2, o colossal Dreadnought Prime assume o controle...". No entanto, de acordo com o código e a estrutura do array `phaseGoals`, a Fase 1 é uma fase normal de eliminação de inimigos comuns (com meta de 25 kills) e o primeiro chefe aparece apenas na Fase 2 (com meta de 1 kill). Confirmamos que o Bossnick será invocado na Fase 2 (primeira fase com chefe) e o Dreadnought Prime nas fases com chefe seguintes (Fase 4, Fase 6, Fase 8, etc.)? Ou devemos mudar as metas de fase?
5. **Comportamento dos Fragmentos de Meteoro**: A especificação diz que ao destruir um meteoro gigante, ele se divide em 2 ou 3 fragmentos menores descendo em velocidade 1.5x mais rápida com desvio lateral. Esses fragmentos menores também devem poder colidir com o jogador e com os tiros do jogador? Ao serem destruídos por tiros do jogador, eles devem pontuar ou gerar power-ups?
